...
- **5 Mathematical Operators**: Combust (⊕), Balance (⊖), Dissolve (⊗), Amplify (⨀), Resonant Contrast (≠)
...
1. **Open the Calculator**:
   ```
   Simply open bea_calculator_web.html in any web browser
   NOTE: Keep all project files in the same folder for proper functionality
   ```
...
- **Category**: Grouping (cognitive, peaceful, energetic, etc.)
...
```
BEA_Game_Calculator_Web_Demo_v1/
├── bea_calculator_web.html    # 🌟 Main application (open this!)
├── BEABit.cs                  # Unity/C# implementation reference
└── README/                    # Documentation folder
    ├── README.md              # This file
    └── PROJECT_OVERVIEW_BEA_Game_Calculator_Web_Demo.md
```
